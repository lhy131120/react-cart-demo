  ...
  const removeCartItem = async (cartItemId) => {
    ...
    try {
      const res = await axios.delete(
        `${API_BASE}/api/${API_PATH}/cart/${cartItemId}`
      );
    ...
    <>
      <div className="container">
        ...
        {cart.carts?.length > 0 && (
          <div className="my-3">
            <div className="container">
              <h2 className="text-center text-uppercase text-success">
                cart list
              </h2>
              <div className="row">
        ...
        <div className="my-5 row justify-content-center">
          <form onSubmit={onSubmit} className="col-md-6">
            <div className="mb-3">
              ...
              />
              {errors.email && (
                <div className="text-danger my-2">{errors.email.message}</div>
              )}
            </div>
            ...
            <div className="mb-3">
              ...
              />
              {errors.name && (
                <div className="text-danger my-2">{errors.name.message}</div>
              )}
            </div>
                ...
                <div className="col-md-3 mb-2 mb-md-0">
                  <input
                    ...
                    className={`form-control ${
                      errors?.telCode && "is-invalid"
                    }`}
                    placeholder="國際區號"
                  />
                  {errors?.telCode && (
                    <div className="text-danger my-2">
                      {errors.telCode?.message}
                    </div>
                  )}
                </div>
